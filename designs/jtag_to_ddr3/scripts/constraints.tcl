...
# -----------------------------------------------------------------------------
#
# Enable backbone routing
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets clk_100mhz_in]

# Disable DDR3 XDC files
set ddr3_xdc [get_files -of_objects [get_files *system_u4_ddr3_0.xci] \
	-filter {FILE_TYPE == XDC}]
set_property IS_ENABLED 0 $ddr3_xdc
